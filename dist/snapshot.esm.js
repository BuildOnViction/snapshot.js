...
import { isBigNumberish, BigNumber as BigNumber$2 } from '@ethersproject/bignumber/lib/bignumber';
...
function strategy$1J(space, network, provider, addresses, options, snapshot) {
    return __awaiter(this, void 0, void 0, function () {
        var blockTag, lpTokenAddress, web3, pairContract, pairsInfo, pairs, pairTotalSupply, stakedLPBalances, lpBalances, stakedTDAO;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    blockTag = typeof snapshot === 'number' ? snapshot : 'latest';
                    lpTokenAddress = options.lpTokenAddress.toLowerCase();
                    web3 = new Web3(new Web3.providers.HttpProvider(networks[network].rpc[0]));
                    pairContract = new web3.eth.Contract(IUniswapV2Pair.abi, lpTokenAddress);
                    pairsInfo = {};
                    return [4 /*yield*/, pairContract.methods.getReserves().call({}, blockTag)];
                case 1:
                    pairs = _a.sent();
                    return [4 /*yield*/, pairContract.methods.totalSupply().call({}, blockTag)];
                case 2:
                    pairTotalSupply = _a.sent();
                ...
                case 4:
                    ...
                    stakedTDAO = stakedLPBalances.returnData.map(function (stakedBalance, index) {
                        return new BigNumber$1(lpBalances.returnData[index].substring(2, 66), 16)
                            .plus(new BigNumber$1(stakedBalance.substring(2, 66), 16))
                            .multipliedBy(new BigNumber$1(pairsInfo['pairs'][0].reserve0))
                            .multipliedBy(new BigNumber$1(2))
                            .div(new BigNumber$1(pairsInfo['pairs'][0].totalSupply));
                    ...
                    return [2 /*return*/, Object.fromEntries(stakedTDAO.map(function (value, i) { return [
                            addresses[i],
                            //   parseFloat(formatUnits(value.toString(), options.decimals))
                            parseFloat(new BigNumber$1(value).div(Math.pow(10, parseInt(options.decimals))).toString(10))
                        ]; }))];
            }
        });
    });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                result = _a.sent();
                return [2 /*return*/, {
                        executionApproved: BigNumber$2.from(result[0][0]).eq(BigNumber$2.from(1)),
                        finalizedAt: BigNumber$2.from(result[1][0]).toNumber()
                    }];
            case 3:
                e_1 = _a.sent();
                return [3 /*break*/, 4];
...
var retrieveInfoFromOracle = function (provider, network, oracleAddress, questionId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                result = _a.sent();
                currentBond = formatEther(BigNumber$2.from(result[1][0]));
                answer = BigNumber$2.from(result[2][0]);
                return [2 /*return*/, {
                        currentBond: currentBond,
                        isApproved: answer.eq(BigNumber$2.from(1)),
                        endTime: BigNumber$2.from(result[0][0]).toNumber()
                    }];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        alreadyClaimed = BigNumber$2.from(historyHash).eq(0);
                        ...
                        votedForCorrectQuestion = currentUserAnswers.some(function (answer) {
                            if (answer) {
                                return BigNumber$2.from(answer).eq(bestAnswer);
                            }
                        }) && isFinalized;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!BigNumber$2.from(currentHistoryHash).eq(0)) return [3 /*break*/, 4];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        currentBond = _a.sent();
                        minimumBondIsZero = BigNumber$2.from(minimumBondInDaoModule).eq(0);
                        minimumBond = minimumBondIsZero
                            ? 1000000000000000
                            : minimumBondInDaoModule;
                        bond = currentBond.eq(BigNumber$2.from(0))
                            ? BigNumber$2.from(minimumBond)
                            : currentBond.mul(2);
